...
class MobileAuthenticationFilterMiddleware implements IAuthenticationFilterService
{
    ...
    public function handle(Request $request, Closure $next)
    {
        ...
        if (!$userApplicationChannelList || count($userApplicationChannelList) == 0) throw new RecordNotFoundException("Resource not found");
