...
use App\Models\Siap\NilaiKompetensiTeknis;
use Illuminate\Http\UploadedFile;
use Illuminate\Support\Facades\DB;

class NilaiKompetensiTeknisService extends NilaiKompetensiTeknis
{
    use SearchService;
    ...
    public function findLatestByNip($nip): ?NilaiKompetensiTeknisService
    {
        return $this
            ->where('nip', $nip)
            ->where('delete_flag', false)
