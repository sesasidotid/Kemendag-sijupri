...
class UserPakService extends UserPak
{
    use SearchService;
    
    private const bucket_name = "pak";
    ...
    public function findById($id): ?UserPakService
    {
    ...
    public function findLatestByNip($nip): ?UserPakService
    {
        return $this
            ->where('nip', $nip)
            ->where('delete_flag', false)
