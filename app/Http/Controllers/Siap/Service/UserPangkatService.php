...
class UserPangkatService extends UserPangkat
{
    use SearchService;
    
    private const bucket_name = "jabatan";
    ...
    public function findById($id): ?UserPangkatService
    {
        return $this
            ->where('id', $id)
    ...
    public function findLatestByNip($nip): ?UserPangkatService
    {
        return $this
            ->where('nip', $nip)
            ->where('task_status', '!=', TaskStatus::REJECT)
