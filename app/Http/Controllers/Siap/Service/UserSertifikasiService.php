...
class UserSertifikasiService extends UserSertifikasi
{
    use SearchService;
    
    private const bucket_name = "sertifikasi";
    ...
    public function findById($id): ?UserSertifikasiService
    {
    ...
    public function findLatestByNip($nip): ?UserSertifikasiService
    {
        return $this
            ->where('nip', $nip)
            ->where('delete_flag', false)
