        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Data Riwayat Jabatan</h4>
                            ...
                            @foreach ($userJabatanList as $index => $jabatan)
                                @if ($jabatan->task_status!='APPROVE')
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ asset('storage/' . $jabatan->file_sk_jabatan) }}" target="_blank"
                                                class="h6">
                                        ...
                                        <td class="text-center">
                                            <button type="button" data-bs-toggle="modal"
                                                data-bs-target="#exampleModalgrid{{ $jabatan->id }}"
                                                class="btn btn-success waves-effect btn-sm waves-light"><i
                                                    class="ri-map-pin-line"></i>Terima
                                            </button>
                                        </td>
                                        <td class="text-center">
                                            <button type="button" data-bs-toggle="modal"
                                                data-bs-target="#tolak{{ $jabatan->id }}"
                                ...
                                @endif
                                <div class="modal fade" id="exampleModalgrid{{ $jabatan->id }}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form method="POST" action="{{ route('/task/user_jf/jabatan/create') }}">
                                                    @csrf
                                                    <div class="row g-3">
                                                        <!--end col-->
                                                        <div class="col-lg-12">
                                                            <div>
                                                                <input type="text" hidden value="{{ $jabatan->id }}"
                                                                    name="id">
                                ...
                                {{-- form tolak --}}
                                <div class="modal fade" id="tolak{{ $jabatan->id }}" tabindex="-1"
                                    aria-labelledby="exampleModalgridLabel" aria-modal="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <p>Silahkan masukan komen pada field dibawah!</p>
                                                <form method="POST"
                                                    action="{{ route('/task/user_jf/jabatan/create') }}">
                                                    @csrf
