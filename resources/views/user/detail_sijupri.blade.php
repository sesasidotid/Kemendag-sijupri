                                ...
                                <tr>
                                    ...
                                    <td class="text-center p-2">
                                        ...
                                        <input type="checkbox" class="form-check-input"
                                            @if ($detailUser->access_method['create'] ?? false) checked @endif name="access_method[create]">
                                    </td>
                                    <td class="text-center p-2">
                                        <label class="form-label">
                                            Update
                                        ...
                                        <input type="checkbox" class="form-check-input"
                                            @if ($detailUser->access_method['update'] ?? false) checked @endif name="access_method[update]">
                                    </td>
                                    <td class="text-center p-2">
                                        <label class="form-label">
                                            Delete
                                        ...
                                        <input type="checkbox" class="form-check-input"
                                            @if ($detailUser->access_method['delete'] ?? false) checked @endif name="access_method[delete]">
                                    </td>
                                </tr>
                            </table>
                        </div>
