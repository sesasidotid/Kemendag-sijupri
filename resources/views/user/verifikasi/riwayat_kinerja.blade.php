                    ...
                    <table class="main-table table nowrap align-middle" style="width:100%">
                        ...
                        <tbody>
                            @foreach ($userPakList as $index => $kinerja)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <button type="button" data-bs-toggle="modal"
                                                data-bs-target="#tolak_kinerja{{ $kinerja->id }}"
                                ...
                                @endif
                                <div class="modal fade" id="tolak_kinerja{{ $kinerja->id }}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form method="POST" action="{{ route('/task/user_j/kinerja/create') }}">
                                                    @csrf
                                                    <div class="row g-3">
                                                        <!--end col-->
                                                        <div class="col-lg-12">
