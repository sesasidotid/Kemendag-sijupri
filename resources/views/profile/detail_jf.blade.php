            ...
            <div class="card-body p-4">
                <div class="tab-content">
                    <div class="tab-pane active" id="Pendidikan" role="tabpanel">
                        @include('profile.riwayat.riwayat_pendidikan')
                    </div>
                    <!--end tab-pane-->
                    <div class="tab-pane" id="Jabatan" role="tabpanel">
                        @include('profile.riwayat.riwayat_jabatan')
                    </div>
                    <!--end tab-pane-->
                    <div class="tab-pane" id="Pangkat" role="tabpanel">
                        @include('profile.riwayat.riwayat_pangkat')
                    </div>
                    <div class="tab-pane" id="kompetensi" role="tabpanel">
                        @include('profile.riwayat.riwayat_kompetensi')
                    </div>
                    <div class="tab-pane" id="sertifikasi" role="tabpanel">
                        @include('profile.riwayat.riwayat_sertifikasi')
                    </div>
                </div>
            </div>
        </div>
