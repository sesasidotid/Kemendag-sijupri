    ...
    <div class="row">
        <div class="col-xxl-12">
            <div class="card">
                <div class="card-body">
                    <form method="POST"
                        action="{{ route('/maintenance/unit_kerja_instansi_daerah/update', ['id' => $unitKerja->id]) }}"
                        class="mb-3">
                        @csrf
                        @method('PUT')
                        @if ($instansi)
                        ...
                        <div class="col-md-12">
                            <div class="mb-3 has-validation">
                                ...
                                <input name="name" type="text" class="form-control"
                                    placeholder="Nama Unit Kerja/Instansi Daerah" value="{{ $unitKerja->name }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3 has-validation">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3 has-validation">
                                ...
                                <input name="phone" type="text" class="form-control" placeholder="Nomor HP"
                                    value="{{ $unitKerja->phone }}">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="mb-3">
                                <label class="form-label">Alamat Instansi</label>
                                <textarea name="alamat" class="form-control" rows="4" placeholder="exp : Jln. Adisucipt , no.8, Kupang">{{ $unitKerja->alamat }}</textarea>
                            </div>
                        </div>
