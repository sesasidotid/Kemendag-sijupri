INSERT INTO test_2.tbl_role (code,created_at,updated_at,created_by,updated_by,name,description,delete_flag,inactive_flag,task_status,comment,tipe,base) VALUES
